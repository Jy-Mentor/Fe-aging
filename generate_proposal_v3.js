...
children.push(new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 200 },
  children: [new TextRun({ text: '（面上项目）', size: 28, font: '宋体' })] }));
...
children.push(p('铁死亡（ferroptosis）是近年发现的一种铁依赖性、脂质过氧化驱动的调节性细胞死亡方式，其形态学、生化和遗传学特征均区别于凋亡、坏死和自噬。铁死亡的核心机制是谷胱甘肽过氧化物酶4（GPX4）活性下降或谷胱甘肽（GSH）耗竭，导致多不饱和脂肪酸磷脂的毒性过氧化产物堆积至致死阈值。关键调控节点包括System Xc\u207b/GPX4抗氧化轴、ACSL4/LPCAT3脂质重塑轴以及铁代谢通路。研究表明，铁死亡在CIRI的急性神经元死亡中发挥重要作用：再灌注带来的大量氧自由基、谷氨酸兴奋性毒性导致的GSH耗竭、以及游离铁的释放，共同构成了铁死亡的完美风暴。抑制铁死亡可显著减小梗死体积、改善神经功能，使其成为CIRI干预的重要靶点。'));

// 2. 细胞衰老与缺血后脑损伤
children.push(h3('2. 细胞衰老与缺血后脑损伤'));
children.push(p('细胞衰老是指细胞在各种应激因素作用下，丧失增殖能力但代谢活跃，进入永久性细胞周期阻滞状态，并分泌大量促炎因子、趋化因子、基质金属蛋白酶和生长因子，构成衰老相关分泌表型（senescence-associated secretory phenotype, SASP）。经典的细胞衰老包括复制性衰老和应激诱导早熟性衰老（stress-induced premature senescence, SIPS），前者由端粒缩短驱动，发生于多次细胞分裂后；后者可由DNA损伤、氧化应激、炎症因子等急性应激在数小时至数天内触发。'));
children.push(p('近年研究发现，脑缺血后梗死周围区（半暗带）的神经元、星形胶质细胞、小胶质细胞和内皮细胞均可出现衰老样改变，表现为SA-\u03b2-gal阳性、p16INK4a/p21CIP1上调、SASP因子分泌增加。这些衰老细胞通过旁分泌效应扩大继发性损伤，抑制神经发生和突触重塑，阻碍远期功能恢复。清除衰老细胞或抑制SASP可改善脑缺血后的远期预后。然而，脑缺血后细胞衰老的触发因素和上游驱动机制尚未完全阐明。'));
...
children.push(p('4-羟基壬烯醛（4-hydroxynonenal, 4-HNE）是脂质过氧化的主要毒性产物之一，具有高度亲电性，可与蛋白质的半胱氨酸、组氨酸和赖氨酸残基发生共价结合，形成蛋白质羰基化修饰。Monroe等[2]在Aging Cell发表的研究证实，4-HNE等脂质过氧化产物可诱导人成纤维细胞和小鼠脂肪干细胞发生衰老，伴随\u03b3H2AX焦点积累、p53信号增强、p21表达上调及SASP分泌。活化的p53一方面通过上调p21诱导细胞周期停滞，另一方面可转录抑制SLC7A11（System Xc\u207b的关键亚基），进一步削弱细胞的抗氧化防御能力，形成脂质过氧化\u2192p53活化\u2192SLC7A11\u2193\u2192更多脂质过氧化的正反馈环路。这一4-HNE-p53-SLC7A11分子轴，可能是铁死亡驱动SIPS的核心机制。需要指出的是，4-HNE对p53的直接羰基化修饰及其在铁死亡-SIPS交互中的特异性作用，目前尚缺乏直接的实验证据，是本项目拟重点验证的科学问题之一。'));

// 4. Nrf2通路——铁死亡与衰老的共同防御枢纽
...
children.push(p('Nrf2通路是铁死亡的重要防御机制\u2014\u2014Nrf2激活可通过上调GPX4增强脂质过氧化物清除能力，通过上调铁蛋白重链（FTH1）螯合游离铁，通过上调System Xc\u207b的亚基SLC7A11增加GSH合成。同时，Nrf2也是抑制细胞衰老和SASP的关键调控因子\u2014\u2014Nrf2缺失可加速衰老表型的出现，而Nrf2激活可延缓衰老进程。因此，Nrf2通路构成了连接铁死亡防御与衰老抑制的共同枢纽，靶向Nrf2有望同时阻断铁死亡的急性损伤和衰老的慢性损害。'));

// 5. 壮瑶药艾叶/桂艾及其活性成分β-石竹烯
...
children.push(p('本研究整合了4个脑缺血时间进程数据集\u2014\u2014GSE104036（小鼠MCAO，RNA-seq，27样本，0-72h）、GSE16561（人缺血性脑卒中，Illumina微阵列，63样本）、GSE61616（大鼠MCAO，Affymetrix微阵列，15样本）及GSE97537（大鼠MCAO，Affymetrix微阵列，12样本）。采用单样本基因集富集分析（ssGSEA），基于Barbie等（Nature Protocols, 2009）的秩加权富集统计算法，计算每个样本的铁死亡、细胞衰老及铁衰老（96基因集）评分。结果显示，在全部4个数据集中，铁衰老评分的疾病-对照效应量（Cohen\'s d）均大于铁死亡评分和衰老评分，表明铁衰老基因集捕获的转录信号与缺血性脑损伤的关联最为紧密，在跨物种、跨平台中具有稳健性。'));

children.push(pNoIndent([
  new TextRun({ text: '（2）时序特征与铁死亡-衰老关系重定义', size: 24, font: '宋体', bold: true })
]));
children.push(p('在GSE104036小鼠MCAO模型中，铁死亡与铁衰老评分均在再灌注后6小时达到峰值，随后下降；而经典的细胞衰老评分并未在后期时间点升高，反而在急性期至亚急性期呈下降趋势。这一发现不支持经典的铁死亡上升\u2192衰老上升\u2192铁衰老过渡序列模式。据此，本项目将分析目标重新定义为高铁衰老活性状态而非过渡窗口，即铁衰老是一个急性的铁死亡相关转录状态，而非迟发性衰老转变。这一发现为后续实验研究指明了方向\u2014\u2014铁依赖性SIPS可能在再灌注后数小时至数天内启动，与急性铁死亡在时间上存在重叠而非先后序列关系。'));
...
children.push(p('将训练好的模型应用于3个独立数据集（不重新训练），预测概率与独立计算的铁衰老评分呈显著正相关：GSE16561（Spearman \u03c1 = 0.56，P < 0.0001）、GSE61616（\u03c1 = 0.75，P < 0.0001）、GSE97537（\u03c1 = 0.88，P < 0.0001）。高中低铁衰老组的AUC分别为0.74、1.00和1.00。需指出，GSE61616和GSE97537样本量较小（12-15样本），完美AUC可能反映小样本过拟合，需在更大队列中验证。'));
...
children.push(p('采用交集+网络邻近扩展双路径策略确定石竹烯干预脑缺血铁衰老的最终核心基因集：最终核心基因集 = （CIRI-铁衰老候选基因 \u2229 石竹烯高置信度靶点） \u222a 网络邻近扩展的铁死亡关键基因。Part A通过五基因CIRI-铁衰老签名与石竹烯427个高置信度靶点（SwissTargetPrediction + STITCH联合预测）取交集，仅包含SAT1，提示SAT1是石竹烯直接作用于铁衰老调控的核心靶点。Part B通过一阶网络邻近分析，在STRING v12.0（人，combined score > 700）网络中，石竹烯靶点的直接邻居中识别出337个铁死亡驱动基因邻近基因（44个直接靶点 + 293个一阶邻居）。超几何检验显示该富集具有极高度统计学意义（P = 2.48 \u00d7 10\u207b\u2074\u00b3），表明石竹烯靶点群与铁死亡调控网络存在高度拓扑关联。'));

children.push(pNoIndent([
  new TextRun({ text: '（2）PPI网络拓扑特征', size: 24, font: '宋体', bold: true })
]));
children.push(p('基于STRING v12.0构建的核心基因PPI子网包含311个节点及1,867条边，网络密度为0.039，平均聚类系数为0.458，提示存在显著的模块化结构。最大连通分量包含306个节点，平均最短路径长度为2.91，网络直径为8，符合小世界网络特征。度中心性排名前10的Hub基因为：TP53（Degree=116）、EGFR（66）、EP300（63）、STAT3（63）、IL6（52）、TNF（51）、HSP90AA1（47）、H3C12（46）、H3C13（46）、SIRT1（45）。其中TP53作为度最高的节点，同时介数中心性亦最高（0.217），是网络信息传递的核心枢纽。NFE2L2（Nrf2）排名第10（Degree=38），处于网络核心位置。'));

children.push(pNoIndent([
  new TextRun({ text: '（3）最短路径分析', size: 24, font: '宋体', bold: true })
]));
children.push(p('对19个核心Hub基因的成对最短路径分析显示，171对Hub基因间平均最短路径长度仅为1.39步，所有Hub基因均处于彼此2步范围内，表明核心调控网络具有高度连通性。铁衰老标记基因到最近Hub基因的平均距离为1.82 \u00b1 0.51步，其中17/20个铁衰老标记基因距离最近Hub仅1步。HIF1A、IL6、IL1B、MAPK14、PTGS2、HMOX1、TFRC等核心铁衰老-炎症基因均直接连接于TP53、EGFR或STAT3等关键Hub，提示铁衰老调控模块深度嵌入核心信号网络。石竹烯唯一直接靶点SAT1到铁衰老标记基因的平均距离为2.84 \u00b1 0.67步（最小2步，最大4步），SAT1通过NFE2L2（Nrf2）桥接至铁死亡调控网络，支持SAT1作为石竹烯干预铁衰老的关键入口节点。'));

children.push(pNoIndent([
  new TextRun({ text: '（4）功能模块划分', size: 24, font: '宋体', bold: true })
]));
...
children.push(pNoIndent([
  new TextRun({ text: '（5）功能富集分析', size: 24, font: '宋体', bold: true })
]));
children.push(p('GO生物过程富集分析显示，核心基因显著富集于细胞因子介导的信号通路、对氧化应激的反应、细胞死亡调控、炎症反应、铁离子稳态及衰老等条目（均adjusted P < 10\u207b\u00b9\u2070）。KEGG通路富集排名前列的包括TNF信号通路、IL-17信号通路、细胞衰老、细胞凋亡、NF-\u03baB信号通路及HIF-1信号通路等。WikiPathways中，Ferroptosis通路（WP4313）排名第4位（adjusted P = 9.19 \u00d7 10\u207b\u00b2\u00b3），进一步支持核心基因集与铁死亡机制的高度关联。'));

// 3. 免疫浸润与铁衰老的协同激活
children.push(h3('3. 免疫浸润与铁衰老的协同激活'));
children.push(p('基于特征基因集的ssGSEA免疫浸润分析显示，在GSE104036的27个样本中，铁衰老评分与多种免疫细胞丰度存在显著相关。其中，中性粒细胞（r = 0.651，P = 2.3 \u00d7 10\u207b\u2074）和M2型巨噬细胞（r = 0.613，P = 6.7 \u00d7 10\u207b\u2074）与铁衰老评分呈强正相关；而小胶质细胞稳态标志（r = -0.738，P = 1.1 \u00d7 10\u207b\u2075）和星形胶质细胞（r = -0.567，P = 0.002）呈显著负相关。Ipsilateral与Sham组比较显示，缺血侧M2型巨噬细胞和中性粒细胞显著升高，而小胶质细胞稳态标志显著下调，与铁衰老评分的组间差异模式一致。'));
children.push(p('在检测的18个关键炎症因子中，15个与铁衰老评分呈显著正相关（P < 0.05），排名前列的包括Ccl2（r = 0.903）、Icam1（r = 0.890）、Cxcl10（r = 0.877）、Stat3（r = 0.875）及Il1b（r = 0.847），强烈支持铁衰老与神经炎症的协同激活机制。'));

// 4. WGCNA共表达网络验证
children.push(h3('4. WGCNA共表达网络验证'));
children.push(p('在GSE16561人脑缺血数据集的加权基因共表达网络（WGCNA）中，337个核心基因中有97个被分配至有意义的共表达模块（非grey模块）。其中turquoise模块包含的核心基因最多，且该模块与铁衰老表型显著相关。核心基因在turquoise模块中的平均模块身份（Module Membership, MM）为0.936，平均基因显著性（Gene Significance, GS）为0.236，证实核心基因集在人脑缺血的共表达调控网络中处于核心位置，具有高模块身份和高表型相关性。'));
...
children.push(bullet('细胞内Fe\u00b2\u207a检测：Phen Green SK探针流式细胞术。'));
...
children.push(p('铁死亡和细胞衰老是当前CIRI研究的两个热点领域，其交互作用（铁衰老）是前沿交叉方向。本项目组前期通过多数据集整合的网络药理学研究，已证实铁衰老转录特征在脑缺血中的稳健存在，预测了BCP与铁死亡调控网络的高度拓扑关联，并初步确定SAT1-Nrf2轴为关键入口节点，为后续实验验证提供了坚实的理论基础。'));

children.push(h2('7.2 材料可行性'));
children.push(p('广西道地桂艾采自广西药用植物园艾叶GAP种植基地，来源明确，活性成分分离平台成熟。BCP标准品为Sigma-Aldrich商品化试剂，纯度\u226598.5%。Nrf2基因敲除小鼠已商用可购。原代神经细胞培养、MCAO/R模型等所需动物和细胞材料均可稳定获取。'));

children.push(h2('7.3 技术可行性'));
children.push(p('项目组已熟练掌握小鼠MCAO/R模型制备、原代神经细胞培养、OGD/R模型、免疫荧光共定位、Western Blot、qRT-PCR、SA-\u03b2-gal染色、透射电镜、行为学检测等全部实验技术。铁死亡和细胞衰老的表征方法均为成熟技术，有大量文献支持和前期预实验基础。网药分析平台稳定运行，具备持续的数据挖掘和分析能力。'));

children.push(h2('7.4 前期工作基础'));
children.push(p('本团队前期已在脑缺血、铁死亡和天然药物神经保护领域积累了扎实的研究基础。已完成4个脑缺血数据集的整合分析，建立了CIRI-铁衰老五基因签名，验证了BCP靶点与铁死亡调控网络的高度拓扑富集（超几何检验P = 2.48 \u00d7 10\u207b\u2074\u00b3）。Hu等[3]已证实BCP通过Nrf2/HO-1通路减轻大鼠脑缺血再灌注损伤，为本项目的延伸研究提供了直接的前期支持。'));

// ============= 八、特色与创新之处 =============
children.push(h1('八、特色与创新之处'));

children.push(h2('8.1 理论创新'));
children.push(p('率先提出并系统验证CIRI半暗带中缺血诱导的铁依赖性SIPS新假说，将铁死亡的急性损伤与细胞衰老的慢性损害通过4-HNE-p53-SLC7A11分子轴有机联系，为理解缺血性脑损伤的慢性化机制提供新视角。与经典ferro-aging（自然衰老模型）的概念在时间尺度和触发因素上明确区分，体现了概念的精确性。'));

children.push(h2('8.2 机制创新'));
children.push(p('揭示壮瑶药桂艾活性成分\u03b2-石竹烯通过激活Nrf2通路协同抑制铁死亡与铁依赖性SIPS的分子机制，首次阐明桂艾通龙路火路、除毒邪功效的铁衰老干预科学内涵。SAT1-Nrf2桥接机制的发现，为天然小分子同时靶向急性死亡和慢性衰老提供了新的作用范式。'));

children.push(h2('8.3 模式创新'));
children.push(p('构建基于壮瑶医药理论的道地药材-功效-核心成分-铁衰老靶点-信号通路精准整合研究模式，将民族医药传统经验与现代前沿生物学（铁死亡、细胞衰老）有机结合，为民族药现代化研究提供了可复制的范例。前期网药分析的系统布局（多数据集验证、机器学习筛选、PPI拓扑分析、功能模块解析），确保了后续实验的靶向性和成功率。'));
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync('D:/铁衰老 绝不重蹈覆辙/标书_整合版V3_桂艾BCP靶向Nrf2抑制铁依赖性SIPS改善CIRI.docx', buffer);
  console.log('Done: proposal generated');
  console.log('File: D:/铁衰老 绝不重蹈覆辙/标书_整合版V3_桂艾BCP靶向Nrf2抑制铁依赖性SIPS改善CIRI.docx');
});
