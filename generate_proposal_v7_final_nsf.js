...
children.push(p('近年来，铁死亡在CIRI中的作用得到广泛验证。多项独立研究表明，脑缺血再灌注后缺血脑组织出现典型的铁死亡特征，包括游离铁升高、GSH耗竭、GPX4活性下降、4-HNE和MDA堆积以及线粒体皱缩等[7,13]。时间进程研究显示，铁死亡标志物在再灌注后数小时内即可升高，与急性期神经元死亡高度吻合。药理学干预证实了铁死亡的因果作用：Ferrostatin-1、Liproxstatin-1及铁螯合剂DFO均可显著减小MCAO模型梗死体积、改善神经功能评分，其保护效应在不同物种和模型中均得到重复。基因水平证据同样支持这一结论：神经元特异性GPX4敲除加剧缺血性损伤，而GPX4过表达或SLC7A11上调则发挥保护作用。细胞特异性研究进一步揭示了铁死亡的复杂性——神经元因高代谢率和高多不饱和脂肪酸含量对铁死亡高度敏感，星形胶质细胞、小胶质细胞及血管内皮细胞的铁死亡也参与病理进程。然而，铁死亡在CIRI中的作用并非仅限于急性期细胞杀伤——亚致死剂量的铁死亡应激是否会触发细胞进入其他应激状态（如细胞衰老），目前尚缺乏系统研究。'));
...
children.push(p('4-羟基壬烯醛（4-hydroxynonenal, 4-HNE）是\u03c9-6多不饱和脂肪酸过氧化的主要毒性醛类产物之一，具有高度亲电性，可与蛋白质的半胱氨酸、组氨酸和赖氨酸残基发生Michael加成反应，形成稳定的蛋白质羰基化修饰[14]。4-HNE在细胞内具有浓度依赖性的生物学效应：低浓度时作为信号分子参与多种通路调控，高浓度时则引发细胞毒性和细胞死亡。在铁死亡过程中，4-HNE是脂质过氧化的重要下游产物和标志物，其水平与铁死亡严重程度正相关。Monroe等[2]在Aging Cell发表的研究系统证实，4-HNE等脂质过氧化产物可在人成纤维细胞和小鼠脂肪干细胞中剂量依赖性地诱导衰老表型，包括SA-\u03b2-gal阳性率升高、\u03b3H2AX焦点积累、p53磷酸化增强、p21表达上调及SASP因子分泌增加。机制研究表明，4-HNE主要通过诱导氧化性DNA损伤、激活DNA损伤应答通路以及直接修饰p53等关键蛋白触发细胞衰老。'));
children.push(p('除4-HNE外，HMGB1/铁自噬环路是另一个受到关注的连接通路：铁死亡细胞释放的HMGB1可结合TLR4受体，激活NF-\u03baB通路驱动SASP形成和炎症反应；同时，SASP中的IL-6、TNF-\u03b1等可上调转铁蛋白受体（TFR1），促进铁摄取，进一步加剧铁过载和脂质过氧化，形成恶性循环。p53作为细胞应激反应的核心转录因子，在铁死亡和细胞衰老中均发挥关键调控作用，是连接二者的理想候选分子。在铁死亡调控方面，p53具有双重角色：既可通过转录抑制SLC7A11促进铁死亡，也可通过调控铁代谢相关基因影响铁死亡敏感性。在衰老调控方面，p53/p21轴是经典的衰老启动通路。值得注意的是，4-HNE可通过羰基化修饰影响p53的活性和稳定性——4-HNE修饰的p53呈现构象改变和半衰期延长，可能导致p53靶基因持续激活。基于这些文献线索，我们推测存在一个4-HNE-p53-SLC7A11正反馈环路：铁死亡产生的4-HNE修饰并激活p53，活化的p53转录抑制SLC7A11，进一步削弱GSH合成和抗氧化防御，加剧脂质过氧化和4-HNE生成，最终将亚致死性氧化应激转化为持续性的衰老表型。'));
...
children.push(p('综上所述，脑缺血再灌注损伤是急性缺血性脑卒中治疗中的重大临床难题，其病理机制涉及急性期多种调节性细胞死亡和慢性期神经炎症与修复障碍。铁死亡作为急性期神经元死亡的关键形式已得到广泛认可；细胞衰老则被认为是缺血半暗带慢性化的重要推手。然而，二者之间的因果联系——即铁死亡是否以及如何驱动缺血半暗带中的细胞衰老（铁依赖性SIPS）——目前尚不清楚。基于文献线索和我们前期的网络药理学研究，我们推测：CIRI半暗带中存在亚致死性铁死亡压力驱动的铁依赖性SIPS，4-HNE-p53-SLC7A11正反馈环路是其核心分子机制；Nrf2作为铁死亡防御与衰老抑制的共同枢纽，是理想的干预靶点；广西道地壮药桂艾的活性成分\u03b2-石竹烯可通过激活Nrf2通路，同时阻断铁死亡急性期损伤和铁依赖性SIPS慢性损害，从而改善CIRI远期预后。'));
children.push(p('本研究的理论意义在于：提出并验证缺血诱导的铁依赖性SIPS这一新型病理概念，丰富对CIRI慢性化机制的认识，为理解铁死亡与细胞衰老的交互作用提供新的实验证据；阐明4-HNE-p53-SLC7A11正反馈环路在铁依赖性SIPS中的核心作用，为铁死亡驱动衰老的分子机制提供新的视角。实践意义在于：阐明壮瑶药桂艾活性成分\u03b2-石竹烯的神经保护新机制，为开发以铁衰老为靶点的脑卒中治疗药物提供理论依据和先导化合物，也为民族医药现代化研究提供可借鉴的研究范式。'));
...
children.push(pNoIndent([
  new TextRun({ text: '（2）时序特征与LASSO稳定性筛选', size: 24, font: '宋体', bold: true })
]));
children.push(p('时序分析显示，铁死亡与铁衰老评分均在再灌注后6小时达到峰值，随后下降；而经典细胞衰老评分并未在后期时间点升高，反而在急性期至亚急性期呈下降趋势。这一发现不支持经典的铁死亡上升\u2192衰老上升\u2192铁衰老过渡序列模式。据此，本项目将分析目标重新定义为高铁衰老活性状态而非过渡窗口，即铁衰老是一个急性的铁死亡相关转录状态，而非迟发性衰老转变。以GSE104036中位数划分的高铁衰老活性组为因变量，以铁衰老基因集表达矩阵为预测变量，采用L1正则化逻辑回归进行特征选择。为确保稳定性，重复50次随机子采样的6折交叉验证，保留选择频率大于50%的基因。结果筛选出5个稳定的CIRI-铁衰老特征基因：SAT1（96%）、EBF3（88%）、KLF6（88%）、LIFR（72%）及CD74（70%）。内部交叉验证AUC为0.73 \u00b1 0.09，置换检验P = 0.002。将训练好的模型应用于3个独立数据集，预测概率与独立计算的铁衰老评分呈显著正相关：GSE16561（\u03c1 = 0.56，P < 0.0001）、GSE61616（\u03c1 = 0.75，P < 0.0001）、GSE97537（\u03c1 = 0.88，P < 0.0001），有力支持了五基因特征对铁衰老活性的预测效能。五个特征基因的功能内涵丰富：SAT1为精脒/精胺N1-乙酰转移酶1，是p53驱动铁死亡的核心介质；KLF6经Nrf2/HO-1轴参与MCAO后铁死亡调控；CD74参与卒中后小胶质细胞活化和神经炎症；LIFR介导脑缺血后的神经保护信号；EBF3是神经元分化因子。'));
...
children.push(p('基于STRING v12.0构建的核心基因PPI子网包含311个节点及1,867条边，网络密度为0.039，平均聚类系数为0.458，提示存在显著的模块化结构。最大连通分量包含306个节点，平均最短路径长度为2.91，符合小世界网络特征。度中心性排名前10的Hub基因为：TP53（Degree=116）、EGFR（66）、EP300（63）、STAT3（63）、IL6（52）、TNF（51）、HSP90AA1（47）、H3C12（46）、H3C13（46）、SIRT1（45）。其中TP53作为度最高的节点，同时介数中心性亦最高（0.217），是网络信息传递的核心枢纽。NFE2L2（Nrf2）度中心性为38，处于网络核心位置，其下游靶基因GPX4、FTH1、SLC7A11等均在核心网络中。采用贪心模块度算法识别出8个紧密连接的功能模块：模块1（TP53种子，83基因，转录调控/细胞周期/应激反应，含E2F、FOXO、Nrf2通路）、模块2（EGFR种子，59基因，炎症免疫/细胞因子信号/NLRP3炎症小体）、模块3（MTOR种子，44基因，自噬-溶酶体通路/铁自噬）、模块4（CAV1种子，30基因，铁代谢调控/脂质代谢）、模块5（HSP90AA1种子，28基因，氧化应激/分子伴侣）、模块6（H3C12种子，27基因，表观遗传调控/组蛋白修饰）、模块7（PRKCA种子，15基因，信号转导）及模块8（ALOX15种子，7基因，花生四烯酸代谢/脂质过氧化执行）。功能富集分析进一步支持上述结论：KEGG通路富集排名前列的包括细胞衰老（29基因，adjusted P = 5.47 \u00d7 10\u207b\u00b2\u00b9）、TNF信号通路（38基因）、细胞凋亡（33基因）及NF-\u03baB信号通路（27基因）等。WikiPathways中，Ferroptosis通路（WP4313，40基因）排名第4位（adjusted P = 9.19 \u00d7 10\u207b\u207b\u00b2\u00b3），进一步支持核心基因集与铁死亡机制的高度关联。'));

children.push(h3('3. 免疫浸润与铁衰老的协同激活及WGCNA验证'));
children.push(p('基于特征基因集的ssGSEA免疫浸润分析显示，在GSE104036的27个样本中，铁衰老评分与多种免疫细胞丰度存在显著相关。其中，中性粒细胞（r = 0.651，P = 2.3 \u00d7 10\u207b\u2074）和M2型巨噬细胞（r = 0.613，P = 6.7 \u00d7 10\u207b\u2074）与铁衰老评分呈强正相关；而小胶质细胞稳态标志（r = -0.738，P = 1.1 \u00d7 10\u207b\u2075）和星形胶质细胞（r = -0.567，P = 0.002）呈显著负相关。在检测的18个关键炎症因子中，15个与铁衰老评分呈显著正相关，排名前列的包括Ccl2（r = 0.903）、Icam1（r = 0.890）、Cxcl10（r = 0.877）、Stat3（r = 0.875）及Il1b（r = 0.847），强烈支持铁衰老与神经炎症的协同激活机制。这一发现提示，铁依赖性SIPS不仅是细胞自主的过程，还可能通过SASP分泌招募外周免疫细胞、激活胶质细胞，形成炎症-衰老正反馈环路。特别值得注意的是，Ccl2和Icam1是单核细胞招募和黏附的关键分子，其与铁衰老评分的高度正相关（r > 0.89）暗示铁衰老细胞可能通过分泌这些趋化因子主动招募外周巨噬细胞，从而放大神经炎症反应。这与文献中SASP招募免疫细胞的报道一致，也为靶向铁衰老减轻脑缺血后慢性炎症提供了理论依据。在样本量最大的人脑缺血数据集GSE16561（63样本）中，加权基因共表达网络（WGCNA）验证显示，337个核心基因中有97个被分配至有意义的共表达模块。核心基因在turquoise模块中的平均模块身份（MM）为0.936，平均基因显著性（GS）为0.236，证实核心基因集在人脑缺血的共表达调控网络中处于核心位置。'));
...
children.push(p('本部分旨在明确CIRI后半暗带中是否存在铁依赖性SIPS，及其时空分布特征、细胞类型和核心分子机制。采用C57BL/6J小鼠MCAO/R模型（缺血60 min），在再灌注后24 h、3 d、7 d、28 d四个时间点取材。运用免疫荧光多重标记技术（NeuN/GFAP/Iba-1分别与铁死亡标志物GPX4/4-HNE/FTH1及衰老标志物p21/\u03b3H2AX共定位）、透射电镜、铁含量比色法及普鲁士蓝染色，系统定量分析铁衰老双阳性细胞的时空分布规律及细胞类型。'));
children.push(p('分子机制方面，采用Western Blot、qRT-PCR、ELISA及免疫沉淀等技术，时序检测半暗带4-HNE蛋白加合物水平、p53总表达及磷酸化与核转位、p21/p16等衰老标志物、SLC7A11/GPX4等铁死亡蛋白及IL-6/IL-1\u03b2/TNF-\u03b1等SASP因子。关键实验采用IP联合抗4-HNE抗体检测p53羰基化修饰，明确4-HNE对p53的共价修饰作用。通过脑立体定位注射AAV-shACSL4下调半暗带ACSL4表达，验证ACSL4作为铁死亡上游调控分子在铁依赖性SIPS启动中的作用。技术难点应对：4-HNE高反应性和不稳定性易致假阴性，所有样本立即以含5 mM DTT和蛋白酶抑制剂的裂解液处理，氮气保护下操作，并设4-HNE处理细胞裂解液为阳性对照。'));

children.push(h2('研究内容二：BCP抗铁依赖性SIPS的细胞机制研究'));
children.push(p('本部分旨在建立稳定的体外铁依赖性SIPS细胞模型，评价BCP的干预效果，并明确Nrf2在其中的关键作用。采用新生24 h内C57BL/6J小鼠原代皮层神经元和星形胶质细胞，以低剂量Erastin（0.5 \u03bcM）和OGD/R（2 h OGD + 24 h复氧）两种方法诱导亚致死量铁死亡压力。优化诱导条件，建立细胞死亡率<15%但呈现典型衰老表型的SIPS模型。评价BCP（1、10、50 \u03bcM）的干预效应，以Liproxstatin-1（200 nM）和DFO（100 \u03bcM）为工具对照，确认其作用是否通过抑制铁死亡实现。'));
children.push(p('Nrf2依赖性验证采用功能获得和缺失策略：Nrf2过表达（质粒转染）和Nrf2沉默（siRNA或ML385）细胞中，观察BCP抗SIPS效应的变化。检测Nrf2核转位、下游靶基因（GPX4、HO-1、FTH1、SLC7A11、NQO1）表达及铁死亡和衰老相关指标。上游机制采用分子对接预测BCP与Keap1疏水口袋结合模式（PDB: 4IQK），结合CETSA验证潜在结合；若不理想则以点突变验证。下游机制重点验证BCP\u2192Nrf2\u2192GPX4\u2191\u21924-HNE\u2193\u2192p53\u2193\u2192SLC7A11\u2191信号轴，通过时序分析和RSL3/p53过表达挽救实验确认上下游关系。'));

children.push(h2('研究内容三：BCP改善CIRI远期预后的整体药效与机制验证'));
children.push(p('本部分旨在整体动物水平验证BCP对CIRI的神经保护效应，重点关注远期功能预后，并确认Nrf2依赖性。采用C57BL/6J小鼠MCAO/R模型，设假手术组、模型组、BCP低/中/高剂量组（102/204/408 mg/kg）、Liproxstatin-1阳性药组（10 mg/kg）、BCP+ML385组（30 mg/kg），每组12只。再灌注后即刻首次给药，随后每日灌胃，连续14天。短期评价（1-3 d）：TTC染色测梗死体积、干湿重法测脑水肿、mNSS评分。远期评价（28 d）：足误实验、转棒实验、Morris水迷宫评估神经功能恢复。'));
children.push(p('Nrf2依赖性验证采用Nrf2基因敲除小鼠（C57BL/6J背景），设野生型+假手术、野生型+模型、野生型+BCP、Nrf2\u207b/\u207b+模型、Nrf2\u207b/\u207b+BCP、Nrf2\u207b/\u207b+溶媒组，每组10-12只。比较梗死体积、脑水肿及远期行为学，确认BCP效应的Nrf2依赖性。28 d脑组织行SA-\u03b2-gal染色、铁死亡-衰老双阳性细胞定量、p53羰基化及衰老和SASP标志物检测、铁死亡指标检测，将BCP药效与铁依赖性SIPS抑制及Nrf2通路激活直接关联。延伸目标：细胞和动物水平比较桂艾挥发油与BCP单体药效，初步探索多成分增益。'));
...
children.push(bullet('实验动物：SPF级C57BL/6J小鼠（22-25 g，雄性），购自北京维通利华；Nrf2基因敲除小鼠（C57BL/6J背景）购自赛业生物。动物饲养于屏障环境，12 h光暗循环，自由摄食饮水。'));
children.push(bullet('药物与试剂：\u03b2-石竹烯（Sigma-Aldrich，纯度\u226598.5%）、桂艾挥发油（本项目提取，GC-MS鉴定）、Erastin/RSL3/Liproxstatin-1（MCE）、DFO（Sigma）、ML385（MCE）、4-HNE（Sigma）、CCK-8试剂盒（同仁化学）、SA-\u03b2-gal染色试剂盒（CST）、C11-BODIPY 581/591（Invitrogen）。'));
...
children.push(bullet('铁死亡检测：Phen Green SK探针测Fe\u00b2\u207a、C11-BODIPY测脂质ROS、GSH/GSSG比色法、TBA法测MDA。'));
children.push(bullet('衰老检测：SA-\u03b2-gal染色、Western Blot检测p21/p16/\u03b3H2AX、qRT-PCR检测SASP因子。'));
children.push(bullet('分子生物学：Western Blot、qRT-PCR、免疫荧光共定位、免疫沉淀（IP）、ELISA等常规技术。'));
children.push(bullet('行为学：Morris水迷宫、转棒实验、足误实验，评估远期神经功能恢复。'));
children.push(bullet('脑立体定位注射：坐标前囟后0.5 mm、旁开3.0 mm、深3.5 mm，微量注射泵注射AAV载体。'));

children.push(h2('5.3 统计学分析'));
children.push(p('所有数据采用GraphPad Prism 9.0和SPSS 26.0软件分析。计量资料以均数\u00b1标准差（x\u0304 \u00b1 s）表示。两组间比较采用独立样本t检验或Mann-Whitney U检验。多组间比较采用单因素方差分析，组间两两比较采用Tukey法或Dunnett法；重复测量数据采用重复测量方差分析。相关性分析采用Pearson或Spearman秩相关。P < 0.05认为差异具有统计学意义。涉及多重比较采用Benjamini-Hochberg法进行错误发现率校正。样本量依据前期预实验结果和文献报道效应量，采用Power分析确定，确保统计效能达到80%以上。'));
...
const techRows = [
  ...
  [
    { text: '', fill: 'FFFFFF' },
    { text: '\u2193 时间：24 h / 3 d / 7 d / 28 d  \u2193 空间：核心区 / 半暗带 / 对侧区  \u2193 细胞：神经元 / 星形胶质细胞 / 小胶质细胞', fill: 'FFFFFF' }
  ],
  [
    { text: '', fill: 'FFFFFF' },
  ...
  [
    { text: '', fill: 'FFFFFF' },
    { text: 'Erastin / OGD/R模型 | SA-\u03b2-gal | p21/p16 | SASP    Nrf2过表达/沉默 | 分子对接 | CETSA    BCP\u2192Nrf2\u2192GPX4\u2191\u21924-HNE\u2193\u2192p53\u2193\u2192SLC7A11\u2191 | 挽救实验 | 时序分析', fill: 'FFFFFF' }
  ],
  [
    { text: '第三部分\n药效验证\n（第3年）', fill: 'FCE4EC' },
  ...
  [
    { text: '', fill: 'FFFFFF' },
    { text: 'MCAO/R模型 | TTC | 脑水肿 | mNSS | 转棒 | 足误 | 水迷宫（28d）    Nrf2\u207b/\u207b小鼠 | 功能 + SIPS标志物验证    桂艾挥发油 vs BCP单体（条件允许时开展）', fill: 'FFFFFF' }
  ],
  [
    { text: '', fill: 'FFFFFF' },
    { text: '\u2193 最终结论：BCP通过激活Nrf2抑制铁依赖性SIPS，改善CIRI远期预后', fill: 'F3E5F5' }
  ],
];
...
children.push(bullet('完成Nrf2在BCP抗铁依赖性SIPS中关键作用的细胞水平验证。'));
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync('D:/铁衰老 绝不重蹈覆辙/标书_国自然标准_final_v7_桂艾BCP靶向Nrf2抑制铁依赖性SIPS改善CIRI.docx', buffer);
  console.log('Done: proposal generated');
  console.log('File: D:/铁衰老 绝不重蹈覆辙/标书_国自然标准_final_v7_桂艾BCP靶向Nrf2抑制铁依赖性SIPS改善CIRI.docx');
});
