...
children.push(p('脑卒中是全球范围内导致成人死亡和长期残疾的首要原因之一。据世界卫生组织统计，全球每年约有1500万人发生脑卒中，其中约500万人死亡，另有500万人遗留永久性残疾。在我国，脑卒中已成为首位致死和致残病因，每年新发病例超过200万，现存患者逾1300万，给家庭和社会带来沉重的疾病负担。《中国脑卒中防治报告2023》数据显示，我国40岁及以上人群脑卒中现患率达2.6%，且发病年龄呈年轻化趋势，65岁以下首次发病患者占比超过50%。值得关注的是，尽管近年来我国脑卒中防治体系建设取得显著进展，但脑卒中的致残率仍居高不下——约70%的存活患者遗留不同程度的神经功能缺损，其中重度残疾者占比超过40%，严重影响患者生活质量，也造成巨大的社会经济损失。'));
children.push(p('急性缺血性脑卒中约占全部脑卒中的70%-80%，其治疗的核心在于尽早恢复血流灌注、挽救缺血半暗带。静脉溶栓和血管内机械取栓是目前唯一被循证医学证实有效的再灌注治疗手段。然而，严格的时间窗限制了临床获益人群：静脉溶栓的时间窗仅为发病后4.5小时，我国卒中中心数据显示，仅约20%的患者能在时间窗内抵达医院，最终接受溶栓治疗的比例不足5%；血管内治疗虽将时间窗延长至6-24小时，但受限于医疗资源分布不均和转诊体系不完善，实际接受取栓治疗的患者比例更低。更为严峻的是，即便在时间窗内成功实现血管再通，仍有近半数患者预后不良——这一现象被称为「无复流」或「再灌注损伤」，提示血流恢复本身可能触发继发性损伤级联反应，抵消再灌注的获益。'));
children.push(p('导致这一困境的根本原因在于脑缺血再灌注损伤（cerebral ischemia-reperfusion injury, CIRI）病理机制的高度复杂性。再灌注在挽救缺血半暗带的同时，也触发了一系列复杂的继发性损伤级联反应，包括氧化应激爆发、兴奋性毒性、神经炎症、血脑屏障破坏、线粒体功能障碍以及多种形式的调节性细胞死亡。这些病理过程并非孤立存在，而是相互交织、互为因果，形成复杂的损伤网络：氧化应激可激活炎症通路，炎症反应又进一步放大氧化损伤；兴奋性毒性导致钙超载，钙超载又触发线粒体通透性转换孔开放，加剧能量代谢障碍和细胞死亡。这种多通路、多靶点的病理网络，使得单一靶点的干预策略往往难以奏效——这也是过去数十年中，数百种神经保护剂在动物实验中有效、却在临床试验中屡屡失败的重要原因之一。'));
children.push(p('从时间维度看，CIRI的病理进程呈现明显的阶段特征。急性期（数小时至1天）以兴奋性毒性、氧化应激爆发和快速细胞死亡为主要特征；亚急性期（数天至数周）则以神经炎症反应、胶质细胞活化和细胞死亡的持续进行为特点；慢性期（数周至数月）则进入神经修复与重塑阶段，但慢性炎症和异常胶质增生往往阻碍功能恢复。传统的神经保护研究多聚焦于急性期的单一病理环节，对亚急性期和慢性期的病理演变机制关注不足，特别是急性期损伤如何向慢性期恶化转化的分子纽带尚未阐明。寻找能够同时干预急性期损伤和慢性期修复障碍的关键病理节点，实现从「单一靶点、单一阶段」向「多靶点、多阶段」的策略转变，是改善缺血性脑卒中远期预后的重要科学问题。'));
...
children.push(p('铁死亡是Stockwell团队于2012年正式命名的一种铁依赖性、脂质过氧化驱动的调节性细胞死亡方式，其形态学、生化和遗传学特征均区别于凋亡、坏死和自噬[4]。在形态学上，铁死亡细胞表现为线粒体皱缩、膜密度增高、线粒体嵴减少或消失，而细胞核形态基本正常，无凋亡小体形成；在生化层面，铁死亡以细胞内游离铁升高、谷胱甘肽（GSH）耗竭、谷胱甘肽过氧化物酶4（GPX4）失活以及脂质过氧化物（L-PUFA-OOH）大量堆积为核心特征；在遗传学上，铁死亡受多个基因的精密调控，涉及铁代谢、脂质代谢、氨基酸代谢等多个生物学过程。经过十余年的研究，铁死亡的调控网络已逐渐清晰，目前认为其核心机制是细胞抗氧化防御系统失能，导致含多不饱和脂肪酸的磷脂发生毒性过氧化产物的大量堆积，最终破坏质膜完整性引发细胞死亡。'));
children.push(p('铁死亡的调控涉及三大核心通路的协同失衡。第一是System Xc\u207b/GPX4抗氧化轴：System Xc\u207b是由SLC7A11和SLC3A2组成的胱氨酸/谷氨酸反向转运体，通过摄取胱氨酸维持细胞内GSH合成，为GPX4提供还原当量；GPX4是目前已知唯一能够直接还原磷脂氢过氧化物的酶，被认为是铁死亡的核心守门分子，其活性或表达下调是铁死亡发生的标志性事件。第二是ACSL4/LPCAT3脂质重塑轴：ACSL4（长链脂酰CoA合成酶4）催化游离花生四烯酸和肾上腺酸生成相应的脂酰CoA，LPCAT3（溶血磷脂酰胆碱酰基转移酶3）则将其掺入膜磷脂中，形成富含多不饱和脂肪酸的磷脂（PUFA-PL），这是铁死亡中脂质过氧化的主要底物。ACSL4的表达水平直接决定了细胞膜PUFA-PL的含量，从而决定细胞对铁死亡的敏感性。第三是铁代谢调控轴：细胞内游离铁（不稳定铁池）通过Fenton反应催化脂质过氧化物生成烷氧自由基，启动和放大脂质过氧化链式反应；铁代谢的关键调控分子包括转铁蛋白受体（TFR1）、铁蛋白（FTH1/FTL）、铁输出蛋白（FPN1）以及铁调节蛋白/铁反应元件（IRP/IRE）系统等，它们共同维持细胞铁稳态。铁代谢紊乱导致的游离铁升高，是铁死亡发生的必要条件[5]。'));
children.push(p('除上述三大核心通路外，铁死亡的调控还涉及多个辅助性防御系统。NAD(P)H/FSP1/CoQ10通路是近年来发现的独立于GPX4的第二条铁死亡抑制通路：铁死亡抑制蛋白1（FSP1，又称AIFM2）具有NAD(P)H依赖的醌氧化还原酶活性，可将CoQ10还原为泛醇（CoQ10H2），后者作为脂溶性自由基捕获剂在质膜上抑制脂质过氧化的传播。GCH1/BH4通路则是另一条不依赖GPX4的防御途径：GTP环化水解酶1（GCH1）催化四氢生物蝶呤（BH4）的从头合成，BH4可通过清除脂质自由基发挥抗氧化作用，同时促进二氢泛醌（CoQ10H2）的生成，与FSP1通路协同抑制铁死亡。此外，ESCRT-III膜修复机制、细胞自噬（特别是铁自噬）以及磷脂转运酶等也参与铁死亡的精细调控。这些多层级的调控网络共同维持细胞的氧化还原稳态，当损伤超过防御系统的代偿能力时，铁死亡即被触发。'));
children.push(p('近年来，铁死亡在CIRI中的作用得到了广泛验证。多项独立研究表明，脑缺血再灌注后，缺血脑组织中出现典型的铁死亡特征，包括游离铁水平升高、GSH耗竭、GPX4活性下降、脂质过氧化产物4-HNE和MDA堆积以及线粒体皱缩等[7,13]。时间进程研究显示，铁死亡标志物在再灌注后数小时内即可检测到升高，其时间动力学与急性期神经元死亡高度吻合。药理学干预实验进一步证实了铁死亡的因果作用：铁死亡特异性抑制剂Ferrostatin-1、Liproxstatin-1以及铁螯合剂DFO均可显著减小MCAO模型的梗死体积、改善神经功能评分，其神经保护效应在不同物种（小鼠、大鼠）、不同缺血模型（MCAO、四血管阻断、双侧颈总动脉阻断）中均得到重复。基因水平的证据同样支持这一结论：神经元特异性GPX4敲除加剧缺血性脑损伤，而GPX4过表达或SLC7A11上调则发挥保护作用。这些研究共同确立了铁死亡作为CIRI急性期神经元死亡关键形式的地位。'));
children.push(p('细胞特异性研究进一步揭示了铁死亡在CIRI中的复杂性。神经元由于其高代谢率、高多不饱和脂肪酸含量以及相对较低的抗氧化能力，对铁死亡高度敏感，是缺血后铁死亡的主要受累细胞类型。然而，越来越多的研究表明，其他细胞类型也参与铁死亡相关的病理过程。星形胶质细胞通过谷氨酸-谷氨酰胺循环调节神经元的兴奋性毒性和氧化还原状态，其铁死亡可破坏胶质瘢痕的形成和神经血管单元的完整性。小胶质细胞/脑内巨噬细胞的铁死亡则可能影响炎症反应的性质和强度——铁死亡的小胶质细胞可释放损伤相关分子模式（DAMP），进一步放大炎症级联反应。血管内皮细胞的铁死亡则直接参与血脑屏障的破坏。此外，少突胶质细胞的铁死亡可能参与缺血后白质损伤的发生发展。这种多细胞类型的铁死亡共同构成了CIRI的复杂病理图景，也提示靶向铁死亡的干预策略可能具有多细胞层面的综合保护效应。'));
...
children.push(p('细胞衰老是指细胞在各种应激因素作用下，退出细胞周期并进入一种稳定的增殖停滞状态，同时伴随广泛的基因表达和代谢重编程，形成特征性的衰老相关分泌表型（senescence-associated secretory phenotype, SASP）[6]。经典的细胞衰老包括端粒依赖性的复制性衰老和应激诱导的早熟性衰老（stress-induced premature senescence, SIPS）。前者与细胞分裂次数相关，主要发生于生理性衰老过程；后者则可由DNA损伤、氧化应激、癌基因激活、炎症因子、线粒体功能障碍等多种急性应激因素在数小时至数天内快速触发，其表型与复制性衰老高度相似但发生机制和时间尺度截然不同。SIPS的核心分子通路包括p53/p21CIP1轴和p16INK4a/Rb轴，二者共同驱动细胞周期停滞的建立和维持。p53/p21轴主要应答急性DNA损伤，通过激活p21抑制周期蛋白依赖性激酶（CDK）活性，导致Rb蛋白去磷酸化，阻滞细胞周期于G1期；p16/Rb轴则更多参与慢性应激和持续性衰老的维持，p16通过抑制CDK4/6维持Rb的低磷酸化状态，加固细胞周期停滞。'));
children.push(p('SASP是衰老细胞最具病理影响力的特征之一，其成分极为复杂，包括促炎细胞因子（IL-6、IL-1\u03b2、TNF-\u03b1等）、趋化因子（CXCL8、CCL2等）、生长因子（TGF-\u03b2、IGFBP等）、基质金属蛋白酶（MMP1、MMP3、MMP9等）以及多种可溶性受体配体和细胞外囊泡。SASP的分泌受到精密的时空调控：衰老早期以抗炎和促修复因子为主，而持续衰老则转为促炎和组织破坏性表型。SASP的调控涉及多条信号通路，其中NF-\u03baB和CCAAT/增强子结合蛋白\u03b2（C/EBP\u03b2）是两个核心转录因子，它们协同调控大量SASP因子的表达。此外，p38 MAPK、mTOR、JAK/STAT以及cGAS-STING等通路也参与SASP的调控。SASP通过旁分泌和内分泌方式重塑组织微环境，既具有清除损伤细胞、促进组织修复的生理功能，也可能在衰老细胞持续存在时导致慢性炎症和组织退行性变——这种双重作用取决于衰老细胞的数量、持续时间以及组织微环境状态。'));
children.push(p('传统观点认为，细胞衰老主要与机体老化和年龄相关疾病有关，在急性损伤中作用有限。然而，近年来这一观念正在被逐步修正。越来越多的证据表明，急性损伤可在多种组织中快速诱导细胞衰老，这些衰老细胞在损伤修复的不同阶段发挥复杂作用——早期可能通过分泌生长因子促进组织修复，晚期则可能因持续存在而阻碍功能恢复。在脑缺血领域，这一现象尤为值得关注。在啮齿类动物MCAO模型中，再灌注后数天内即可在半暗带检测到SA-\u03b2-半乳糖苷酶（SA-\u03b2-gal）阳性细胞，同时伴随p21和p16表达上调、\u03b3H2AX焦点增加等衰老标志物的激活[8]。发生衰老的细胞类型包括神经元、星形胶质细胞、小胶质细胞以及血管内皮细胞，提示缺血性应激诱导的衰老具有细胞普遍性。临床样本研究同样提供了支持性证据：缺血性脑卒中患者的脑脊液和外周血中可检测到衰老相关生物标志物的升高，且其水平与梗死体积和功能预后相关。'));
children.push(p('缺血半暗带中的衰老细胞在空间分布上呈现异质性特征。梗死核心区周边的半暗带是衰老细胞最集中的区域，这里的细胞经历了亚致死性的缺血应激，既未发生快速坏死，也未能完全恢复正常功能。从时间动态来看，衰老细胞在再灌注后数天内即可出现，并可持续存在数周甚至数月——这种持续性的衰老细胞负荷与慢性神经炎症和不良功能预后密切相关。值得注意的是，衰老具有「传播效应」：衰老细胞通过SASP中的因子（如IL-6、TGF-\u03b2、活性氧等）可诱导周围正常细胞也进入衰老状态，从而扩大衰老细胞的范围和影响。这种旁分泌的衰老传播机制，可能是缺血半暗带进行性扩大、神经功能持续恶化的重要原因之一。此外，衰老细胞还可通过细胞外囊泡和缝隙连接等方式传递衰老信号，进一步扩大其病理影响范围。'));
children.push(p('缺血诱导的衰老细胞并非被动的旁观者，而是通过多种机制积极参与病理进程。首先，SASP中的促炎因子和趋化因子可招募外周免疫细胞浸润、激活脑内固有免疫细胞，形成慢性炎症微环境，加剧继发性损伤。其次，衰老细胞分泌的基质金属蛋白酶可降解细胞外基质，破坏血脑屏障完整性和神经环路结构。再次，SASP因子通过旁分泌方式诱导周围正常细胞发生衰老（衰老的传播效应），扩大损伤范围。最后，衰老的神经元和胶质细胞丧失正常生理功能，阻碍突触重塑和神经发生，影响脑损伤后的修复与重塑。从干预角度，利用衰老细胞清除剂（senolytics）选择性清除衰老细胞或抑制SASP分泌，在多种脑损伤模型中均显示出改善功能预后的效果，为靶向衰老的治疗策略提供了原理验证。然而，脑缺血后细胞衰老的触发因素和上游驱动机制尚未完全阐明，特别是氧化应激在衰老启动中的具体作用形式和分子通路仍有待深入揭示。'));

children.push(h3('4. 铁死亡与细胞衰老的交汇：铁衰老概念及其在CIRI中的研究空白'));
children.push(p('铁死亡与细胞衰老并非两个独立的病理过程，二者之间存在密切的交互作用和共同的上游驱动因素——氧化应激和铁代谢紊乱。近年来，研究者开始将这两个领域联系起来，提出了铁衰老（ferro-aging/ferro-senescence）的概念框架。铁衰老概念的提出，源于对铁代谢、脂质过氧化与衰老三者关系的逐步认识。早期研究发现，铁过载与多种年龄相关疾病的发生发展相关；随后的研究证实，铁可通过氧化应激途径诱导细胞衰老；近年来，随着铁死亡研究的深入，研究者开始意识到，铁死亡过程中产生的脂质过氧化产物可能是驱动细胞衰老的关键介质。2026年，Liu等[1]在Cell Metabolism发表的灵长类动物研究为铁衰老概念提供了系统性的体内证据：该研究发现，随着灵长类年龄增长，肝脏和血清中铁水平逐渐升高，同时伴随ACSL4表达上调和脂质过氧化产物积累；铁过载可通过ACSL4介导的脂质过氧化通路驱动肝细胞和造血干细胞发生衰老，形成铁代谢紊乱\u2192脂质过氧化\u2192细胞衰老的完整级联；反之，抑制ACSL4或敲除铁调素调控基因可减轻衰老表型、延长健康寿命。这一研究首次在高等哺乳动物中确立了ferro-aging作为生理性衰老驱动因素的地位，其时间尺度为月至年级，属于慢性衰老过程。'));
...
children.push(p('4-羟基壬烯醛（4-hydroxynonenal, 4-HNE）是\u03c9-6多不饱和脂肪酸过氧化的主要毒性醛类产物之一，具有高度亲电性，可与蛋白质的半胱氨酸、组氨酸和赖氨酸残基发生Michael加成反应，形成稳定的蛋白质羰基化修饰[14]。4-HNE在细胞内具有浓度依赖性的生物学效应：低浓度时可作为信号分子参与多种信号通路的调控，高浓度时则引发细胞毒性和细胞死亡。在铁死亡过程中，4-HNE是脂质过氧化的重要下游产物和标志物，其水平与铁死亡严重程度正相关。近年来，4-HNE在细胞衰老中的作用逐渐被认识。Monroe等[2]在Aging Cell发表的研究系统证实，4-HNE等脂质过氧化产物可在人成纤维细胞和小鼠脂肪干细胞中剂量依赖性地诱导衰老表型，包括SA-\u03b2-gal阳性率升高、\u03b3H2AX焦点积累、p53磷酸化增强、p21表达上调以及SASP因子分泌增加。机制研究表明，4-HNE主要通过诱导氧化性DNA损伤、激活DNA损伤应答（DDR）通路以及直接修饰p53等关键蛋白来触发细胞衰老。这些发现提示，脂质过氧化产物4-HNE可能是连接铁死亡与细胞衰老的关键分子介质。'));
children.push(p('除4-HNE外，铁死亡与细胞衰老之间还存在多个潜在的分子连接枢纽。HMGB1/铁自噬环路是近年受到关注的另一条通路：铁死亡细胞释放的高迁移率族蛋白B1（HMGB1）可结合细胞膜上的TLR4受体，激活NF-\u03baB信号通路，驱动SASP形成和炎症反应；同时，SASP中的IL-6、TNF-\u03b1等促炎因子可上调转铁蛋白受体（TFR1）表达，促进细胞铁摄取，进一步加剧铁过载和脂质过氧化，形成铁死亡\u2192HMGB1\u2192SASP\u2192铁摄取增加\u2192更多铁死亡的恶性循环。此外，铁自噬（ferritinophagy）也可能在铁衰老中发挥作用——铁蛋白的选择性自噬降解导致游离铁释放增加，既促进铁死亡发生，也通过氧化应激途径推动细胞衰老。Nrf2/ARE通路的失活则是另一个关键交汇点：Nrf2既是铁死亡防御的核心调控者，又是抑制细胞衰老和SASP的关键转录因子，其功能下降可能同时放大铁死亡和衰老两个过程。这些多层次的分子连接，构成了铁死亡与细胞衰老交互作用的复杂网络。'));
...
children.push(p('然而，目前关于铁死亡驱动细胞衰老的研究主要集中于肿瘤细胞和体外细胞系，在神经系统特别是缺血性脑损伤中的研究极为有限。已有的少数研究多为关联性观察，缺乏因果性验证和机制解析。例如，CIRI半暗带中是否确实存在铁依赖性SIPS？其时空分布特征如何？哪些细胞类型主要受累？4-HNE-p53-SLC7A11分子轴是否在其中发挥关键作用？HMGB1/TLR4炎症环路是否参与铁死亡-衰老恶性循环的放大？这些问题目前均缺乏直接的实验证据，有待系统研究加以阐明。填补这些研究空白，对于深入理解CIRI的病理机制、发现新的治疗靶点具有重要的理论和实践意义。'));

children.push(h3('5. Nrf2通路：铁死亡防御与衰老抑制的共同枢纽'));
children.push(p('核因子E2相关因子2（nuclear factor erythroid 2-related factor 2, Nrf2）是细胞抗氧化反应的主调控因子，属于碱性亮氨酸拉链转录因子家族。在生理状态下，Nrf2被Keap1（Kelch样ECH关联蛋白1）锚定在胞浆中，并经Cullin-3介导的泛素-蛋白酶体途径快速降解，保持较低的基础水平。当细胞暴露于氧化应激或亲电试剂时，Keap1分子中的关键半胱氨酸残基（如Cys151、Cys273、Cys288）发生共价修饰，导致Keap1构象改变，丧失对Nrf2的泛素连接酶活性。新生的Nrf2逃脱降解并转位入核，与小Maf蛋白形成异二聚体，结合于抗氧化反应元件（antioxidant response element, ARE）的保守序列上，启动下游数百个靶基因的转录。Nrf2靶基因涵盖了抗氧化酶、解毒酶、物质代谢转运、蛋白质稳态、铁代谢调控等多个功能类别，共同构成细胞的综合性防御体系。除经典的Keap1-Nrf2通路外，Nrf2还受多种非经典机制的调控，包括PI3K/Akt、MAPK、PKC、GSK-3\u03b2等激酶的磷酸化修饰，以及自噬-溶酶体途径对Keap1的降解等。这些多层次的调控机制确保了Nrf2能够对多种应激信号做出精准应答。'));
children.push(p('Nrf2通路是铁死亡的重要防御机制。Nrf2可通过多层面的调控抑制铁死亡发生：在抗氧化层面，Nrf2上调GPX4的表达直接增强磷脂过氧化物清除能力，同时上调SLC7A11促进胱氨酸摄取和GSH合成，间接维持GPX4活性；此外，Nrf2还转录激活HO-1、NQO1、GCLC、GCLM等多种抗氧化酶，全面增强细胞的抗氧化防御能力。在铁代谢层面，Nrf2转录激活铁蛋白重链（FTH1）和铁蛋白轻链（FTL），促进游离铁的螯合储存，还可通过上调铁输出蛋白FPN1降低细胞内不稳定铁池水平；同时，Nrf2下调TFR1表达，减少铁摄取，从多方面维持铁稳态。在脂质代谢层面，Nrf2调控ACSL4等脂质重塑相关酶的表达，影响膜磷脂的脂肪酸组成，降低细胞对铁死亡的敏感性[12]。此外，Nrf2还可通过上调FSP1、GCH1等不依赖GPX4的铁死亡防御分子，构建多层防御网络。这些多维度的调控使Nrf2成为铁死亡防御网络中的核心节点。'));
children.push(p('Nrf2同样是抑制细胞衰老和SASP的关键因子。多项研究表明，Nrf2的表达和活性随年龄增长而下降，这种下降与衰老表型的出现和年龄相关疾病的发生发展密切相关。在细胞水平，Nrf2缺失或功能低下可加速氧化应激诱导的SIPS，表现为SA-\u03b2-gal阳性率升高、端粒缩短加速、SASP分泌增强；反之，Nrf2激活则可延缓多种细胞类型的衰老进程，减轻SASP相关的炎症反应。Nrf2抑制衰老的机制是多方面的：直接清除活性氧减轻DNA损伤，维持基因组稳定性；上调II相解毒酶增强细胞防御，减少外源性和内源性毒素的损伤；抑制NF-\u03baB通路减少SASP因子转录，减轻慢性炎症；调节自噬-溶酶体通路维持蛋白质稳态和细胞器质量控制；调控能量代谢和线粒体功能，改善细胞能量状态。这些机制共同作用，使Nrf2成为联系氧化应激、炎症和衰老的核心调控分子。鉴于Nrf2在铁死亡防御和衰老抑制中的双重核心作用，我们认为Nrf2通路是一个理想的干预靶点——激活Nrf2有望同时阻断铁死亡的急性期损伤和铁依赖性SIPS的慢性期损害，实现对CIRI病理进程的双阶段干预。'));
children.push(p('在脑卒中研究领域，Nrf2通路的神经保护作用已得到广泛验证。动物实验表明，Nrf2激活剂（如莱菔硫烷、姜黄素、槲皮素等）可显著减小MCAO模型的梗死体积、改善神经功能评分；而Nrf2敲除则加剧缺血性脑损伤。临床研究也提供了支持性证据：Nrf2基因多态性与缺血性脑卒中的发病风险和预后相关，Nrf2启动子区功能获得性突变携带者的卒中风险降低、预后更好。然而，目前关于Nrf2在脑卒中的研究多关注其急性期抗氧化和抗炎作用，对其在亚急性和慢性期的作用，特别是对细胞衰老和远期功能恢复的影响，研究相对较少。此外，从天然产物中筛选高效、低毒的Nrf2激活剂，并阐明其作用机制，仍是脑卒中治疗研究的重要方向。广西道地壮药桂艾的活性成分\u03b2-石竹烯，由于其明确的Nrf2激活活性和良好的安全性，有望成为这一领域的候选分子。'));

children.push(h3('6. 壮瑶药艾叶/桂艾及其活性成分\u03b2-石竹烯：从民族药经验到现代药理机制'));
children.push(p('艾叶（Artemisia argyi L\u00e9vl. et Vant.）为菊科蒿属植物的干燥叶，是我国传统中药和广西道地壮瑶药材。艾叶入药历史悠久，始载于《名医别录》，被列为中品，其性温，味辛、苦，归肝、脾、肾经，具有温经止血、散寒止痛、外用祛湿止痒等功效。在壮瑶医药理论体系中，艾叶具有独特的地位：壮语称\u300c挨\u300d，瑶语称\u300c各艾\u300d，被视为\u300c通龙路火路、除风毒寒毒、逐湿邪\u300d之要药。壮医\u300c三道两路\u300d理论认为，脑（巧坞）为神明之府，龙路火路网络密布；中风（麻邦）是由于风毒、火毒、痧毒循龙路火路上攻巧坞，致三道两路不通、气血失衡、天地人三气不能同步。艾叶的\u300c通龙路火路、除毒邪\u300d功效，恰中中风病的病机要害，因此在壮瑶医临床中常用于麻痹、头痛、眩晕等脑病的防治，常用方法包括艾熏、艾灸、煎汤内服等。艾叶的\u300c解毒除蛊\u300d功效，可从现代药理学角度解读为清除自由基、抗炎、调节细胞死亡与免疫功能等多重作用。这种传统功效与现代药理的对应关系，为艾叶的现代化研究提供了理论桥梁。'));
children.push(p('桂艾是产于广西地区的艾叶道地药材，因独特的地理气候条件而具有挥发油含量高、活性成分丰富的特点。广西地处亚热带季风气候区，光照充足、雨量充沛、土壤肥沃，为艾叶的生长提供了优越的自然环境。广西产艾叶不仅挥发油含量显著高于其他产地，而且化学成分组成也存在差异——倍半萜类成分含量更高，抗氧化和抗炎活性更强。桂艾挥发油是艾叶的主要药效物质基础，采用水蒸气蒸馏法或超临界CO2萃取法制备，得油率约为0.45%-1.2%。已从桂艾挥发油中分离鉴定出数十种化学成分，主要包括倍半萜类、单萜类、黄酮类及酚酸类化合物，其中\u03b2-石竹烯（\u03b2-caryophyllene, BCP）的含量可高达15%-35%，是桂艾挥发油中最重要的倍半萜成分之一。\u03b2-石竹烯是一种天然存在的双环倍半萜化合物，广泛分布于多种植物的挥发油中，具有独特的丁香香气。由于其良好的安全性，BCP已被美国FDA和欧洲食品安全局（EFSA）批准为食品添加剂，广泛应用于食品、化妆品和香料工业。'));
children.push(p('现代药理学研究揭示了BCP的多种生物活性，包括抗炎、抗氧化、镇痛、抗肿瘤、保肝、护胃以及神经保护等。其中，抗炎和抗氧化活性是BCP最受关注的药理作用。BCP是大麻素CB2受体的选择性激动剂，可通过CB2受体依赖的信号通路发挥抗炎和免疫调节作用——CB2受体主要表达于免疫细胞，激活后可抑制促炎因子释放、调节免疫细胞迁移和分化。在抗氧化方面，近年来的研究发现BCP可显著激活Nrf2/ARE信号通路，上调多种抗氧化酶和\u2161相解毒酶的表达。具体而言，BCP可通过修饰Keap1的半胱氨酸残基或激活PI3K/Akt、ERK等上游信号激酶，促进Nrf2核转位和转录激活，进而上调HO-1、NQO1、GCLC、GCLM等靶基因的表达，增强细胞的抗氧化防御能力。BCP的这种CB2受体激活和Nrf2通路激活的双重特性，使其在炎症相关疾病和氧化应激损伤中具有独特的治疗优势。'));
children.push(p('在神经系统疾病领域，BCP的神经保护作用已在多种模型中得到验证。Hu等[3]在Phytomedicine发表的研究明确证实，BCP可通过激活Nrf2/HO-1通路减轻大鼠脑缺血再灌注损伤：BCP预处理可剂量依赖性地减小MCAO/R模型的梗死体积、降低脑水肿程度、改善神经功能评分，同时伴随脑组织中Nrf2核转位增加、HO-1表达上调以及氧化应激指标（MDA、SOD）的改善；而Nrf2抑制剂ML385可显著逆转BCP的神经保护效应。此外，BCP在帕金森病、阿尔茨海默病、癫痫、糖尿病神经病变等神经系统疾病模型中也显示出良好的保护作用。药代动力学研究表明，BCP具有良好的血脑屏障穿透能力，口服给药后可迅速进入脑组织并维持有效浓度，这为其中枢神经系统疾病的治疗应用提供了药代动力学基础。值得注意的是，BCP的安全性极高：急性毒性试验显示其LD50大于5000 mg/kg，亚慢性和慢性毒性试验均未发现明显的毒副作用，临床应用前景广阔。'));
children.push(p('近年来，BCP与铁死亡的关系开始受到关注。有研究报道BCP可通过激活Nrf2通路抑制肝纤维化模型中的铁死亡[15]，在顺铂耳毒性模型中也观察到BCP对铁死亡的抑制作用[16]。在结肠炎模型中，BCP通过抑制巨噬细胞铁死亡缓解肠道炎症；在心肌缺血再灌注损伤模型中，BCP通过激活自噬和抑制铁死亡发挥心肌保护作用。这些研究为BCP调控铁死亡提供了初步的实验支持。然而，BCP是否能够通过激活Nrf2通路同时阻断铁死亡和铁依赖性SIPS，是否能够通过干预铁死亡-衰老正反馈环路改善CIRI的远期预后，目前尚未见文献报道。考虑到BCP明确的Nrf2激活活性、良好的血脑屏障穿透性以及极高的安全性，系统研究BCP对铁依赖性SIPS的干预作用及其分子机制，具有重要的理论价值和转化潜力。'));
...
children.push(p('本项目拟围绕上述科学假说，综合运用动物模型、细胞生物学、分子生物学、网络药理学等多学科技术手段，系统验证CIRI中铁依赖性SIPS的存在，解析其分子调控机制，明确\u03b2-石竹烯通过Nrf2通路干预铁依赖性SIPS的药效与机制。本研究的理论意义在于：第一，提出并验证缺血诱导的铁依赖性SIPS这一新型病理概念，丰富对CIRI慢性化机制的认识，为理解铁死亡与细胞衰老的交互作用提供新的实验证据；第二，阐明4-HNE-p53-SLC7A11正反馈环路在铁依赖性SIPS中的核心作用，为铁死亡驱动衰老的分子机制提供新的视角；第三，揭示Nrf2通路在铁死亡-衰老交互调控中的枢纽地位，深化对细胞应激防御网络整体性的认识。实践意义在于：第一，阐明壮瑶药桂艾活性成分\u03b2-石竹烯的神经保护新机制，为开发以铁衰老为靶点的脑卒中治疗药物提供理论依据和先导化合物；第二，为民族医药现代化研究提供可借鉴的研究范式，推动壮瑶医药从经验医学向循证医学的转变；第三，为脑卒中的治疗提供新的策略——从单一靶点、单一阶段干预转向多靶点、多阶段的综合干预。'));
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync('D:/铁衰老 绝不重蹈覆辙/标书_国自然标准_v6_桂艾BCP靶向Nrf2抑制铁依赖性SIPS改善CIRI.docx', buffer);
  console.log('Done: proposal generated');
  console.log('File: D:/铁衰老 绝不重蹈覆辙/标书_国自然标准_v6_桂艾BCP靶向Nrf2抑制铁依赖性SIPS改善CIRI.docx');
});
